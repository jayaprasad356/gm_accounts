...
@section('title', translate('Add new Project Cost'))
<style>
    .password-container{
        position: relative;
    }
    ...
    <div class="content container-fluid">
        ...
        <div class="pb-3">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class=""><i class="tio-add-circle-outlined"></i> {{translate('add')}} {{translate('new')}} {{translate('projectcost')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.project_cost.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
